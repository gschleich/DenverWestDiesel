...
IMAGES_TO_OPTIMIZE = {
    ...
    'open_hoods.jpg': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'white_truck.jpg': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'trucks_side.jpg': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'shop_vehicles.jpg': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'Mechanical1.png': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'Mechanical2.png': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'Mechanical3.png': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'Mechanical4.png': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    'Mechanical5.png': {'type': 'hero', 'web_width': 1920, 'mobile_width': 1440},
    # About section image
    'DWDTeamEdit.png': {'type': 'content', 'web_width': 1400, 'mobile_width': 1280},
    # Logo
...
def main():
    ...
    for filename, config in IMAGES_TO_OPTIMIZE.items():
        ...
        # Mobile version (very high quality for excellent visual experience)
        mobile_filename = os.path.splitext(filename)[0] + mobile_ext
        mobile_path = os.path.join(mobile_dir, mobile_filename)
        mobile_quality = 95 if config['type'] == 'hero' else 92
